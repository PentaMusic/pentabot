...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    console.log(userProfile?.nickname, userProfile?.display_name);
                ...
                {user && (
                    <>
                        <div className="navigation-menu">
                            <button className="nav-menu-item" onClick={() => onNavigateToKnowledge?.()}>
                                <KnowledgeIcon />
                                지식 베이스
                            </button>
                        </div>
                        ...
                        >
                            ...
                            <div className="user-details">
                                <span className="user-name">
                                    {userProfile?.nickname || userProfile?.display_name || user.display_name || user.email.split('@')[0]}
                                </span>
