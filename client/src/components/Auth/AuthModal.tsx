            ...
            <div className="auth-modal">
                ...
                <div className="auth-modal-content">
                    <div className="auth-header">
                        ...
                        <p>
                            {mode === 'signin'
                                ? 'Sign in to continue to Pentabot'
                                : mode === 'signup'
                                ? 'Join Pentabot today'
                    ...
                    <form onSubmit={mode === 'reset' ? handlePasswordReset : handleSubmit} className="auth-form">
                        {mode === 'signup' && (
                        ...
                        <button
                            type="submit"
                            className={mode === 'reset' ? 'auth-submit-btn auth-color-warning' : 'auth-submit-btn'}
                            disabled={isLoading}
                        >
                            {isLoading ? (
                    ...
                    {mode !== 'signup' && (
                        <p className="auth-right">
                            <button type="button" className="auth-reset" onClick={() => handleModeChange('reset')}>
                                Forgot Password?
                            </button>
                        </p>
                    )}
