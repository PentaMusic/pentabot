...
export const LockIcon: React.FC<IconProps> = ({ width = 12, height = 12, className }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const ChartBarIcon: React.FC<IconProps> = ({ width = 16, height = 16, className }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const AdminIcon: React.FC<IconProps> = ({ width = 16, height = 16, className }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
